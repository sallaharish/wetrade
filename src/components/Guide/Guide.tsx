...
const tools = [
  ...
  },
  {
    ...
    description:
      "Apply stop-loss, take-profit, and capital protection settings.",
  },
];
const Guide = () => {
    ...
    <div>
      ...
      <div className="trading-container">
        <div className="heading-section">
          ...
          <p className="subheading">
            Auto Trading Software executes trades on your behalf using advanced
            algorithms and real-time market data. It reduces emotional
            decision-making, increases efficiency, and allows you to capitalise
            on market movements—automatically.
          </p>
        </div>
        ...
        <div className="tools-wrapper">
          {tools.map((tool, index) => {
            ...
            return (
              <div key={index} className={`tool-card ${bgClass}`}>
